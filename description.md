...
Ничего лишнего не хранит, использует функции со сложностью O(1). Сложность O(1).
...
Ничего лишнего не хранит, использует функций со сложностью O(1). Сложность O(1).
...
Хранит несклько целочисленных значений, использует функцию со сложностью O(1). Сложность O(1).
