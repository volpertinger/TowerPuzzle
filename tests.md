...
Тестирует решение игры 4 на 4 методом распространения ограничений без использования проверки возможных комбинация чисел в ряду и столбце по видимости.

#### Тест 2

Тестирует решение игры 5 на 5 распространением ограничеий.

#### Тест 3
Тестирует решение игры 6 на 6 методом распространения ограничений с заданием некоторых значений в поле.

#### Тест 4
Тестирует решение игры 7 на 7 методом распространения ограничений с заданием некоторых значений в поле.

#### Тест 5
Тестирует решение игры 8 на 8 методом распространения ограничений с заданием некоторых значений в поле.

#### Тест 6
Тестирует решение игры 9 на 9 методом распространения ограничений с заданием некоторых значений в поле.

#### Тест 7
Тестирует решение игры 4 на 4 методом распространения ограничений с заданием некоторых значений в поле и отсутствием некоторых ограничений по видимости.

#### Тест 8
Тестирует решение игры 4 на 4 методом распространения ограничений с отсутствием некоторых ограничений по видимости и необходимостью перебора.

#### Тест 9
Тестирует решение игры 5 на 5 методом распространения ограничений с заданием некоторых значений в поле и отсутствием некоторых ограничений по видимости и необходимостью перебора.

#### Тест 10
Тестирует решение игры 6 на 6 методом распространения ограничений с заданием некоторых значений в поле и отсутствием некоторых ограничений по видимости и необходимостью перебора.

#### Тест 11
Тестирует решение игры 7 на 7 методом распространения ограничений с заданием некоторых значений в поле и отсутствием некоторых ограничений по видимости и необходимостью перебора.

#### Тест 12
Тестирует решение игры 8 на 8 методом распространения ограничений с заданием некоторых значений в поле и отсутствием некоторых ограничений по видимости и необходимостью перебора.

#### Тест 13
Тестирует решение игры 9 на 9 методом распространения ограничений с заданием некоторых значений в поле и отсутствием некоторых ограничений по видимости и необходимостью перебора.
